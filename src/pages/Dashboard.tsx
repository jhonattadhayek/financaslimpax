...
import { TrendingUp, TrendingDown, Building, Wallet, ChevronUp, ChevronDown, Download } from 'lucide-react';
import { DashboardData, getFinancialSummary } from '../services/dashboard';
import { exportDashboardReport } from '../services/export';
...
function Dashboard() {
  ...
  const handleExport = async () => {
    try {
      await exportDashboardReport(summary);
    } catch (error) {
